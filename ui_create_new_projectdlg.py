...
#
# Created: Thu May  2 14:51:24 2013
...
class Ui_newprojectdialog(object):
    def setupUi(self, newprojectdialog):
        ...
        newprojectdialog.resize(504, 720)
        ...
        self.verticalLayout_2.addWidget(self.what_type_of_data_Label)
        ...
        self.metric_choice_frame = QtGui.QFrame(newprojectdialog)
        self.metric_choice_frame.setFrameShape(QtGui.QFrame.StyledPanel)
        self.metric_choice_frame.setFrameShadow(QtGui.QFrame.Raised)
        self.metric_choice_frame.setObjectName(_fromUtf8("metric_choice_frame"))
        self.verticalLayout = QtGui.QVBoxLayout(self.metric_choice_frame)
        self.verticalLayout.setObjectName(_fromUtf8("verticalLayout"))
        self.label_3 = QtGui.QLabel(self.metric_choice_frame)
        self.label_3.setWordWrap(True)
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.verticalLayout.addWidget(self.label_3)
        self.horizontalLayout_3 = QtGui.QHBoxLayout()
        self.horizontalLayout_3.setObjectName(_fromUtf8("horizontalLayout_3"))
        self.label_6 = QtGui.QLabel(self.metric_choice_frame)
        self.label_6.setObjectName(_fromUtf8("label_6"))
        self.horizontalLayout_3.addWidget(self.label_6)
        self.metric_cbo_box = QtGui.QComboBox(self.metric_choice_frame)
        self.metric_cbo_box.setObjectName(_fromUtf8("metric_cbo_box"))
        self.horizontalLayout_3.addWidget(self.metric_cbo_box)
        spacerItem = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem)
        self.verticalLayout.addLayout(self.horizontalLayout_3)
        self.verticalLayout_2.addWidget(self.metric_choice_frame)
        ...
        self.verticalLayout_2.addWidget(self.outcome_name_Frame)
...
"effect size", None))
        ...
        self.label_3.setText(_translate("newprojectdialog", "Please choose the appropriate metric for the data type chosen above or just accept the listed default.\n"
"\n"
"Note, however, that if you are importing data via a CSV and you have effect data, it is ESSENTIAL that you choose the proper metric corresponding to your data now.", None))
        self.label_6.setText(_translate("newprojectdialog", "Metric:", None))
