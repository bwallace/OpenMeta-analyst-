...
"C:\Program Files\Bat_To_Exe_Converter\Windows (32 bit)\Bat_To_Exe_Converter.exe" -bat LaunchOpenMetaAnalyst.bat -save LaunchOpenMetaAnalyst.exe -icon ../images/meta.ico