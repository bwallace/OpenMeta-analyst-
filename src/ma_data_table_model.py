...
#    @staticmethod
#    def helper_headerData(section, orientation, role=Qt.DisplayRole,
#                          data_type, sub_type, raw_columns, outcome_columns, length_dataset):
#        ''' Allows access to headerData information w/o having to make a data model '''
#        
#        
#        
