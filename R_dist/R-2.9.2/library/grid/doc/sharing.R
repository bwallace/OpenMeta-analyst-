...
###################################################
### chunk number 2: axes1 eval=FALSE
###################################################
...
###################################################
### chunk number 3: axes2 eval=FALSE
###################################################
## x <- 1:10
## y1 <- rnorm(10)
...
###################################################
### chunk number 4: axes3 eval=FALSE
###################################################
## y2 <- rnorm(10)
...
###################################################
### chunk number 6: axesedit eval=FALSE
###################################################
...
pdf("shared2-%02d.pdf", onefile=FALSE,
  width=4, height=2)
pushViewport(viewport(layout=grid.layout(1, 2, respect=TRUE)))
