...
###################################################
### chunk number 5: multi-part3
###################################################
model.response(mf1)


###################################################
### chunk number 6: multi-part4
###################################################
...
###################################################
### chunk number 7: multi-response1
###################################################
F2 <- Formula(y1 + y2 ~ x3)
length(F2)
...
###################################################
### chunk number 8: multi-response2
###################################################
...
###################################################
### chunk number 9: multi-response3
###################################################
model.response(mf2)


###################################################
### chunk number 10: multi-response4
###################################################
model.part(F2, data = mf2, lhs = 1)


###################################################
### chunk number 11: single-response
###################################################
model.part(F1, data = mf1, lhs = 1, drop = TRUE)


###################################################
### chunk number 12: details1
###################################################
...
###################################################
### chunk number 13: details2
###################################################
attr(F3, "lhs")


###################################################
### chunk number 14: formula-method
###################################################
formula(F3)
...
###################################################
### chunk number 15: terms-method1
###################################################
terms(F3)


###################################################
### chunk number 16: terms-method
###################################################
formula(terms(F3))
...
###################################################
### chunk number 17: model.frame-method
###################################################
...
###################################################
### chunk number 18: model.matrix-method
###################################################
model.matrix(F3, data = mf3, rhs = 2)


###################################################
### chunk number 19: model.response-substitute
###################################################
...
###################################################
### chunk number 20: model.foo-methods
###################################################
model.weights(mf3)


###################################################
### chunk number 21: update-method
###################################################
update(F1, . ~ . - x1 | . + x1)
update(F1, . + y2 | y3 ~ .)
...
###################################################
### chunk number 22: as.Formula-method
###################################################
as.Formula(y1 ~ x1, y2 ~ x2, ~ x3)


###################################################
### chunk number 23: ivcoef
###################################################
...
###################################################
### chunk number 24: ivcoef-example
###################################################
