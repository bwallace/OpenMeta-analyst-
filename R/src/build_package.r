...
flist <- c("classes.r", "binary_methods.r", "bivariate.r", "continuous_methods.r", "diagnostic_methods.r",
             "data_transform.r", "meta_methods.r", "plotting.r", "meta_reg.r", "utilities.r")  
